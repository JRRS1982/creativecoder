<header id="header">
    ...
    <ul class="icons">
        ...
        <li><a href="https://www.instagram.com/jeremyrrsmith/?hl=en" class="icon brands fa-instagram" target="_blank"><span class="label">Instagram</span></a></li>
        <li><a href="https://medium.com/@jeremyrrsmith" class="icon brands fa-medium-m" target="_blank"><span class="label">Medium</span></a></li>
    </ul>
</header>